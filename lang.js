...
const translations = {
    ...
    'en': {
        ...
        'back': '◀️ Back',
        'load_necesidades': '📂 Load Needs',
        'save_necesidades': '💾 Save Needs',
        'load_ideas': '📂 Load Ideas',
        'save_ideas': '💾 Save Ideas',
        'load_evaluacion': '📂 Load Evaluation',
        'save_evaluacion': '💾 Save Evaluation',
        'error_loading_file': 'Could not read the file. Make sure it is a valid .txt file generated by this application.',
        'start': '🚀 Start',
        'calculate': '🧮 Calculate',
