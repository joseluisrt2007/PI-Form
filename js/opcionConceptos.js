...
function setupButtons() {
    ...
    if (btnSi) {
        btnSi.addEventListener('click', function() {
            // Guardar preferencia de que el usuario quiere hacer exploración de conceptos
            data.realizarConceptos = true;
    ...
    if (btnNo) {
        btnNo.addEventListener('click', function() {
            // Guardar preferencia de que el usuario NO quiere hacer exploración de conceptos
            data.realizarConceptos = false;
            localStorage.setItem('projectData', JSON.stringify(data));
