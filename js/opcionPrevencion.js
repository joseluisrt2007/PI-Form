...
function setupButtons() {
    ...
    if (btnSi) {
        btnSi.addEventListener('click', function() {
            // Guardar preferencia de que el usuario quiere hacer prevención
            data.realizarPrevencion = true;
    ...
    if (btnNo) {
        btnNo.addEventListener('click', function() {
            // Guardar preferencia de que el usuario NO quiere hacer prevención
            data.realizarPrevencion = false;
            localStorage.setItem('projectData', JSON.stringify(data));
